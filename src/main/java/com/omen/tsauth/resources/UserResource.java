package com.omen.tsauth.resources;

import java.util.Date;
import java.util.HashMap;
import java.util.Map;

import com.omen.tsauth.Constants;
import com.omen.tsauth.domain.User;
import com.omen.tsauth.services.UserService;
...
//Adds response body and controller anotation//
@RestController
